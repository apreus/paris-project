...
function toggleFeature(feature) {
    let classList = document.getElementById("body_notes").classList;
    if (classList.contains(feature)) {
        classList.remove(feature);
    } else {
...
function hideHowto() {
    howto = document.getElementById("howto").style.visibility="hidden";
}
